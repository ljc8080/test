<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"F:\www\pyg\public/../application/home\view\goods\item.html";i:1571373966;s:51:"F:\www\pyg\application\home\view\Common\layout.html";i:1571369113;}*/ ?>
<!DOCTYPE html>
<html>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$('#addcar').click(function () {
			...
			$.post("https://www.digou.ltd/home/shop_car/add",
					request_data,
					function (data, textStatus, jqXHR) {
						console.log(data);
						if(data.code==200){
							let spec_id = goodsprice[ids]['spec_goods_id']?goodsprice[ids]['spec_goods_id']:0;
							location.href = `https://www.digou.ltd/home/shop_car/successcart?goods_id=${request_data.goods_id}&number=${request_data.number}&spec_goods_id=${spec_id}`;
							//location.href = `https://www.digou.ltd/home/shop_car/successcart`;
						}else{
							console.log(data);
