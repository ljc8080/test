<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"F:\www\pyg\public/../application/home\view\goods\index.html";i:1569235505;s:51:"F:\www\pyg\application\home\view\Common\layout.html";i:1571369113;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="py-container">
			...
			<div class="details">
				...
				<div class="goods-list">
					<ul class="yui3-g">
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<li class="yui3-u-1-5">
							<div class="list-wrap">
								<div class="p-img">
									<a href="/goods/<?php echo $v['id']; ?>" target="_blank"><img src="<?php echo $v['goods_logo']; ?>" /></a>
								</div>
								<div class="price">
									<strong>
											<em>¥</em>
								...
								<div class="cu">
									<em><?php echo (isset($v['goods_remark']) && ($v['goods_remark'] !== '')?$v['goods_remark']:'无'); ?></em>
								</div>
								<div class="commit">
									<i class="command">已有<?php echo $v['comments_num']; ?>人评价</i>
								</div>
								<div class="operate">
...
<script>
	$(function () {
		$('#logout').click(function () {
			$.get("https://www.digou.ltd/user/logout",
