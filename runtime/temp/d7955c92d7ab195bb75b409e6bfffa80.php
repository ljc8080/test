<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"F:\www\pyg\public/../application/admin\view\goods\product-edit.html";i:1572493511;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="<?php echo url('update'); ?>" method="post" class="form form-horizontal" id="form-add">
		...
		<div id="tab-system" class="HuiTab">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否秒杀：</label>
					<div class="formControls col-xs-8 col-sm-9">
						是:<input type="radio" name="seckill"  value="1">
						否:<input type="radio" name="seckill"  value="0" checked='checked'>
					</div>
				</div>
			</div>
		</div>
